...
<link rel="stylesheet" href="custWrite.css" />
		...
		<table width="700" border="3" bordercolor="white" align="center">
			...
			<tr align="center" valign="middle">
				<td colspan="5"><a
					...
					class="btn btn-primary btn-lg active" role="button"
					aria-pressed="true" onclick="location.href='./list?pageNum=${pageNum}'">취소</a></td>
			</tr>
		</table>
	</form>
	<footer>
